...
Route::middleware('auth')->group(function () {
    ...
    Route::get('employee', [\App\Http\Controllers\UserController::class, 'edit'])->name('employee.edit');
    Route::post('employee', [\App\Http\Controllers\UserController::class, 'delete'])->name('employee.delete');
